...
class Deque:
    ...
    def add_front(self,item):
        ...
        The runtime is linear, or O(n), because every time you insert into the front of a list, all the other items
    ...
    def add_rear(self,item):
        """
        Takes in an item as a parameter and appends that item to the end of the list that is representing the Deque.
    ...
    def size(self):
        ...
        The runtime will be constant because all we're doing in finding the length of a list and returning that value.
        """
        return len(self.items)

    def is_empty(self):
        """
        Checks to see if the list representing our Deque is empty. Returns True if it is, or False it it isn't.
